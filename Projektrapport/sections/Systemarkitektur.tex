...
\section{Lagmodel}
I Projektet er der anvendt en lagdelt arkitektur, som er opdelt i tre lag. De tre lag er Presentations, Buisness logik  og Data access. Systemet er lavet så det skulle være muligt at skifte et hver lag ud til hver en tid. For fuld beskrivelse af lagopdelingen henvises til dokumentationen

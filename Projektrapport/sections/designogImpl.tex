\chapter{Design}
Det er i projektet arbejdet lodret ned igennem lagene når nye features skulle designes. Det er lavet så der udvikles en feature fuldstændigt ned igennem lagene. Det er derfor valgt at beskrive en feature hele vejen ned igennem for at eksemplificere selve designet af systemmet. For fuld beskrivelse af systemmetdesignet se dokumentationen. 

\section{Modeldesign}

Ud fra domæneanalysen er dataen der giver mening at persistere fundet, og på fig. \ref{fig:BarteradModel} kan ses hvad der skulle gemmes i forbindelse med barterads.

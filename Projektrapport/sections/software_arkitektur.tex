...
På figur \ref{fig:Domaneanalyse} ses domæneanalysen af BargainBarter. Denne analyse er lavet på baggrund af de definerede user stories som kan findes i bilaget\footnote{Se bilag - Dokumentation, sektion 3.2}. Domæneanalysen er det første overordnede udkast til designet af BargainBarter. Dette betyder, at den indeholder afgørende valg for systemets overordnede struktur. I domæneanalysen er alle systemets konceptuelle klasser fundet samt deres grænseflader. Domæneanalysen  kan ses på figur \ref{fig:Domaneanalyse}. Figuren indeholder systemets konceptuelle klasser, som binder problemdomænet sammen med softwarearkitekturen til systemet.    
\begin{figure}[H]
	\centering
	\includegraphics

...
\begin{table}[H]
	\begin{tabular}{ |p{1.4cm}|p{5.0cm}|p{5.0cm}|p{3.8cm}|p{1.0cm}| } 
		...
		\hline
		Punkt 7 & Skriv en bruger-vurdering på over 500 tegn og tryk ''Send'' & Der kommer en pop-up meddelse om, at vurdering er for lang og vurderingen bliver ikke gemt &  & \\
		\hline
		Punkt 8 & Skriv en bruger-vurdering på under 500 tegn og tryk ''Send''. Når der trykkes på ''Send'' startes et stop-ur og uret stoppes, når bruger-anmeldelsen offentliggøres & Stop-uret viser mindre end 15 sekunder &  & \\
		\hline
	\end{tabular}

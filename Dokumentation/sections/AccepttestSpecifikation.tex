...
\begin{table}[H]
	\begin{tabular}{ |p{1.4cm}|p{5.0cm}|p{5.0cm}|p{3.8cm}|p{1.0cm}| } 
		...
		\hline 
		Punkt 6 & En bruger skriver ''Hej'' til en anden bruger gennnem det indbyggede chat-modul. Når der trykkes på send startes et stop-ur og uret stoppes, når den anden kan se beskeden & Stop-uret står på mindre end 15 sekunder & &  \\
		\hline
...
\begin{table}[H]
	\begin{tabular}{ |p{1.4cm}|p{5.0cm}|p{5.0cm}|p{3.8cm}|p{1.0cm}| } 
		...
		\hline
	\end{tabular}
	\caption{Accepttestspecifikation af ikke-funktionelle krav del 2}

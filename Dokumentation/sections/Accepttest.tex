...
\begin{table}[H]
	\begin{tabular}{ |p{1.4cm}|p{5.0cm}|p{5.0cm}|p{3.8cm}|p{1.0cm}| } 
		...
		\hline
		Punkt 9 & Tilgå hjemmesiden fra en af de afgivne enheder i afsnit \ref{ch:Ikkefunktionelle} via \url{http://10.29.0.30/bargainbarter}, log ind og opret en BarterAd  & En BarterAd er blevet opret i systemet & En BarterAd er blevet opret i systemet & \checkmark \\
		\hline
	\end{tabular}

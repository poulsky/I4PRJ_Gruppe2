...
Chatten blev testet på baggrund af flowet fra figur \ref{fig:chatflow}.Resultatet af chat-testen set fra en anden brugers web-klient ses på figur \ref{fig:chattest}.
\begin{figure}[H]
	\centering
	\includegraphics

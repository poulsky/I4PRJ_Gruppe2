...
Af cross cutting concerns i projektet har der bl.a. været verificering af en brugers log in på de forskellige sider. Dvs. at visse dele af hjemmesiden skulle ikke være tilgængeligt med mindre brugeren var logget ind. Til at løse dette problem er ASP.NET identity\cite{Identity} blevet brugt og udvidet med de oplysninger der har været nødvendige for at projektet har passet på domænet.
